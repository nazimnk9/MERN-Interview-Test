    ...
    <div className='pt-5'>
        <div className='w-full flex justify-center items-center h-[250px] bg-gradient-to-r from-[#4c76cf] to-[#552ab8] relative rounded-md overflow-hidden'>
            ...
            <div className={`rounded-[5px] absolute top-16 right-3 gap-3 bg-[#36bdc7] w-[250px] p-4 text-white ${show ? 'visible opacity-100' : 'invisible opacity-50'} transition-all duration-500`}>
                ...
                <button className='py-2 px-4 text-[13px] overflow-hidden text-center bg-[#e9e8eb] text-black font-bold rounded-[3px] hover:bg-black hover:text-white w-full'>Create New Design</button>
            </div>
            <div>
